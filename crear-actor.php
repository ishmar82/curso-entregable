<?php
	...
	if ($_POST) {
		$actorToSave = new Actor($_POST['nombre'], $_POST['apellido'], $_POST['rating']);
		
		$actorToSave->setFavoriteMovie($_POST['fav_movie_id']);
						...
						<div class="row">
							<div class="col-6">
								<div class="form-group">
									<label>Nombre:</label>
									<input type="text" class="form-control" placeholder="Ej: Star Wars" name="nombre">
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									<label>Apellido:</label>
									<input type="text" class="form-control" placeholder="Ej: 8.5" name="apellido">
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
							...
							<div class="col-6">
								<div class="form-group">
									<label>Pelicula Preferia:</label>
									<select class="form-control" name="fav_movie_id">
